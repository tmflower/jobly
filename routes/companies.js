...
router.get("/:handle", async function (req, res, next) {
  try {
    ...
    const companyJobs = await Job.getByCompany(req.params.handle);
...
router.patch("/:handle", ensureLoggedIn, hasAdminAuth, async function (req, res, next) {
  try {
...
router.delete("/:handle", ensureLoggedIn, hasAdminAuth, async function (req, res, next) {
  try {
